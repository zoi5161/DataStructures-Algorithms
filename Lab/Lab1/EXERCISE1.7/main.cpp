...
void empty(int &n)
{
    if(n == 0)
        ...
        cout << "The queue still has " << n << " elements." << endl;
}
...
void print(int &n, bool &stop)
{
    ...
    if(s == "PUSH")
    {
        ...
        if(n + k > MAX)
        {
            cout << endl << "The queue can hold " << MAX - n << " elements." << endl;
    ...
    else if(s == "POP")
    {
        ...
        {
            cout << endl;
            cout << "There aren't any elements in the queue" << endl;
        ...
        else
        {
            ...
            {
                cout << endl;
                cout << "Too few elements to pop off the queue." << endl;
